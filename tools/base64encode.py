...
def auto_encode_decode(input_string):
    """Kollar ifall en sträng är base64-encodad eller decodad och kör båda beräkningarna"""
    try:
        ...
        print("Detektion: Strängen var Base64-kodad.")
        ...
        print("Detektion: Strängen var i klartext.")
